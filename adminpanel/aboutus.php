...
$aboutusdesc=$hcl->getaboutuscontents();
...
{
    $hcl->updateaboutuscontents($_POST['aboutus']);
}
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form method="post" action="#">
                <div class="form-group">
                    <label for="aboutus">About Us Description</label>
                    <textarea name="aboutus" id="aboutus" required="required">
                        <?php echo $aboutusdesc['description']; ?>
                    </textarea>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-success" name="aboutupdate" id="aboutupdate">
