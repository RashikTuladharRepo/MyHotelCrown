    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="dashboardcontent">
                Welcome To The Custom Content Management System For Hotel Crown.<br>
                <p>Please Use The Menu On The Left Side For Necessary Operations.</p>
                <p style="font-size: 12px;">Customized CMS For Hotel Crown &copy; 2015, Kathmandu, Nepal</p>
            </div>
        </div>
    </div>
</div>
